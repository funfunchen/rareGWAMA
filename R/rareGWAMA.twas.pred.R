...
#'
#' @param b.vec marginal effect of each genetic variant; note this has to be marginal effects;
#' @param s.vec the standard error for each genetic variant;
#' @param r2.mat the LD matrix for the predictors, which can be approximated from a reference panel;
#' @param n sample size;
#' @param group a group of categories for the predictors, should be of values 1,2, ... etc;
#' @param lambda tuning parameters for L2 penalties
#' @param alpha tuning parameters for L1 panelties
#' @export
